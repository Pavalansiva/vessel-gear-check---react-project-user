    ...
    <div className="dashboard">
      ...
      <div className="box">
                <div className='selection'>
                    <input type='text' placeholder='Enter a New Department' style={{width:200, height: 40, border: 3,
                        marginTop: 69,marginLeft:20, outline: 'none', paddingLeft: 35, fontSize: 13, textalign: "center", }}></input>
